...
if(localStorage.getItem("ubication")=="login"){
    ...
    $("<div id='register-div'><form id='login'><p>Nombre de usuario</p><input type='text' name='user' placeholder='Username' required='required' id='nombreUsuarioLogin'/>"+
    "<p>Contraseña</p><input type='password' name='pass' placeholder='Password' required='required' id='PassUsuarioLogin'/><br><br><button class='boton' id='btn-login'>"+
