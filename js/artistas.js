    ...
    $.ajax({
        ...
        success: function (resultado) {
          ...
          for (var x of resultado) {
            ...
            arrayArtista.push({ name: x.nombre_artista, src: x.imagen_artista, facebook: x.facebook, instagram:x.instagram, bandcamp:x.bandcamp, genero:x.genero, propias:x.propias});
...
$("</br></br><h1>Artistas relacionados:</h1><div class='no-local'></div>").appendTo(".content-extension");
$("</br></br><h1>Artistas locales:</h1><div class='locales'></div>").appendTo(".content-extension");


        arrayArtista.forEach(element => {
            if(element.name == "Double Horse"){
                $("<div class='imagen-en-artista'><img src='assets/artistas/"+element.src+"' alt='"+element.name+"' ></div><h1>"+element.name+"</h1><div class='texto-artist'><p>&nbsp; &nbsp; &nbsp; &nbsp; Double Horse es una banda de Doom Metal valenciana que"+
                ...
                $("<div class='div-artistas-relacionados'><img src='assets/artistas/"+element.src+"' alt='"+element.name+" image of the band' title='"+element.name+"' class='img-artistas-relacionados'><div class='name-band'> <b> "+element.name+"</b></div></div><br><br>")
              .appendTo(".no-local");
              ...
              $("<div class='div-artistas-relacionados'><img src='assets/artistas/"+element.src+"' alt='"+element.name+" image of the band' title='"+element.name+"' class='img-artistas-relacionados'><div class='name-band'> <b> "+element.name+"</b></div></div>")
              .appendTo(".locales");
              $(".img-artistas-relacionados").mouseenter(function(){ 
                $(this).animate({ width: "105%", height: "105%"}, 500, "linear");
               });
    ...
    function mostrarCDs(arrayMerch){
        ...
        arrayMerch.forEach(element => {
            if(element.id_artista == 5){
                $("<div class='contenedor-producto' id='cd-dh'><div class='div-productos-relacionados'><img src='assets/cds/"+element.img_cd+"' alt='"+element.cd_nombre+"' class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.cd_nombre+"</p></div></div>"
                ).appendTo("main");
            }
    })
    $(".img-artistas-relacionados").mouseenter(function(){ 
...
function mostrarCasetes(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 5){
            $("<div class='contenedor-producto' id='casete-dh'><div class='div-productos-relacionados'><img src='assets/casetes/"+element.img_casete+"' alt='"+element.casete_nombre+"' class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.casete_nombre+"</p></div></div>"
            ).appendTo("main");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
...
function mostrarVinilos(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 5){
            $("<div class='contenedor-producto' id='vinilo-dh'><div class='div-productos-relacionados'><img src='assets/vinilos/"+element.img_vinilo+"' alt='"+element.vinilo_nombre+"' class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.vinilo_nombre+"</p></div></div>"
            ).appendTo("main");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
...
function mostrarCamisetas(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 5){
            $("<div class='contenedor-producto' id='camiseta-dh'><div class='div-productos-relacionados'><img src='assets/camisetas/"+element.img_camiseta+"' alt='"+element.camiseta_nombre+"'  class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.camiseta_nombre+"</p></div></div>"
            ).appendTo("main");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
...
$("</br></br><h1>Artistas locales:</h1><div class='locales'></div>").appendTo(".content-extension");
        arrayArtista.forEach(element => {
            if(element.name == "Bloody Crom"){
                $("<div class='imagen-en-artista'><img src='assets/artistas/"+element.src+"' alt='"+element.name+"' ></div><h1>"+element.name+"</h1><div class='texto-artist'><p>&nbsp; &nbsp; &nbsp; &nbsp; Bloody Crom es un grupo valenciano que fusiona el sonido del Heavy Metal"+
                ...
                "<div class='video-youtube'><iframe width='560' height='315'  title='Youtube video of Bloody Crom' src='https://www.youtube.com/embed/Jf3fBl2Hgsw' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe></div><div class='products'></div>")
                .appendTo("main");
            }else if(element.genero == "punk"){
                $("<div class='div-artistas-relacionados'><img src='assets/artistas/"+element.src+"' alt='"+element.name+" image of the band' title='"+element.name+"' class='img-artistas-relacionados'>"+element.name+"<div class='name-band'> <b> "+element.name+"</b></div></div>")
              .appendTo(".no-local");
...
function mostrarCasetes(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 7){
            $("<div class='contenedor-producto' id='casete-bc'><div class='div-productos-relacionados'><img src='assets/casetes/"+element.img_casete+"' alt='"+element.casete_nombre+"' class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.casete_nombre+"</p></div></div>"
            ).appendTo("main");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
...
function mostrarCamisetas(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 7){
            $("<div class='contenedor-producto' id='camiseta-bc'><div class='div-productos-relacionados'><img src='assets/camisetas/"+element.img_camiseta+"' alt='"+element.camiseta_nombre+"'  class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.camiseta_nombre+"</p></div></div>"
            ).appendTo("main");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
      ...
      $("</br></br><h1>Artistas locales:</h1><div class='locales'></div>").appendTo(".content-extension");
        arrayArtista.forEach(element => {
            if(element.name == "Here the captain speaking, the captain is dead"){
                $("<div class='imagen-en-artista'><img src='assets/artistas/"+element.src+"' alt='"+element.name+"' ></div><h1>"+element.name+"</h1>"+
...
function mostrarCasetes(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 8){
            $("<div class='contenedor-producto' id='casete-captain'><div class='div-productos-relacionados'><img src='assets/casetes/"+element.img_casete+"' alt='"+element.casete_nombre+"' class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.casete_nombre+"</p></div></div>"
            ).appendTo(".products");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
...
function mostrarVinilos(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 8){
            $("<div class='contenedor-producto' id='vinilo-captain'><div class='div-productos-relacionados'><img src='assets/vinilos/"+element.img_vinilo+"' alt='"+element.vinilo_nombre+"' class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.vinilo_nombre+"</p></div></div>"
            ).appendTo("main");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
...
function mostrarCamisetas(arrayMerch){
    ...
    arrayMerch.forEach(element => {
        if(element.id_artista == 8){
            $("<div class='contenedor-producto' id='camiseta-captain'><div class='div-productos-relacionados'><img src='assets/camisetas/"+element.img_camiseta+"' alt='"+element.camiseta_nombre+"'  class='img-artistas-relacionados'></div><div class='name-product'> <p> "+element.camiseta_nombre+"</p></div></div>"
            ).appendTo("main");
        }
})
$(".img-artistas-relacionados").mouseenter(function(){ 
...
if(localStorage.getItem("ubication") == "Hawkwind"){
  $('html, body').animate({ scrollTop: 0 }, 1000);
    function artistas(arrayArtista){
      ...
      $("</br></br><h1>Artistas locales:</h1><div class='locales'></div>").appendTo(".content-extension");
        arrayArtista.forEach(element => {
            if(element.name == "Hawkwind"){
                $("<div class='imagen-en-artista'><img src='assets/artistas/"+element.src+"' alt='"+element.name+"' ></div><h1>"+element.name+"</h1>"+
                "<div class='texto-artist'><p>&nbsp; &nbsp; &nbsp; &nbsp; Hawkwind es una banda inglesa de space rock formada a finales de los años sesenta, en Ladbroke Grove, Londres. Fue una de las bandas pioneras de dicho género. Sus letras contienen temáticas acerca de lo urbano y la ciencia ficción; de hecho, el escritor Michael Moorcock ha colaborado en las letras de algunos temas."+
                "<br><br><i class='fa-brands fa-bandcamp'></i><a href='"+element.bandcamp+"' target='_blank'>Bandcamp de "+element.name+"</a><br><i class='fa-brands fa-facebook'></i><a href='"+element.facebook+"' target='_blank'>Facebook de "+element.name+"</a><br><i class='fa-brands fa-instagram-square'></i><a href='"+element.instagram+"' target='_blank'>Instagram de"+element.name+" </a></p>"+
                  "</div><div class='video-youtube'><iframe width='560' height='315' src='https://www.youtube.com/embed/X3W7ch0oLeA' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe></div>")
                .appendTo("main");
            }else if(element.genero == "space rock"){
                $("<div class='div-artistas-relacionados'><img src='assets/artistas/"+element.src+"' alt='"+element.name+" image of the band' title='"+element.name+"' class='img-artistas-relacionados'>"+element.name+"<div class='name-band'> <b> "+element.name+"</b></div></div>")
              .appendTo(".no-local");
...
if(localStorage.getItem("ubication") == "Zig Zags"){
  $('html, body').animate({ scrollTop: 0 }, 1000);
    function artistas(arrayArtista){
      ...
      $("</br></br><h1>Artistas locales:</h1><div class='locales'></div>").appendTo(".content-extension");
        arrayArtista.forEach(element => {
            if(element.name == "Zig Zags"){
                $("<div class='imagen-en-artista'><img src='assets/artistas/"+element.src+"' alt='"+element.name+"' ></div><h1>"+element.name+"</h1>"+
                "<div class='texto-artist'><p>&nbsp; &nbsp; &nbsp; &nbsp; Zig Zags es un trío de heavy metal/punk rock con sede en Los Ángeles. La banda está formada por el cantante y guitarrista Jed Maheu, el baterista Dane Arnold y el bajista Sean Hoffman. Clash ha descrito su música como un 'diagrama de Venn que conecta Black Sabbath, Black Flag y Motörhead'."+
                "<br><br><i class='fa-brands fa-bandcamp'></i><a href='"+element.bandcamp+"' target='_blank'>Bandcamp de "+element.name+"</a><br><i class='fa-brands fa-facebook'></i><a href='"+element.facebook+"' target='_blank'>Facebook de "+element.name+"</a><br><i class='fa-brands fa-instagram-square'></i><a href='"+element.instagram+"' target='_blank'>Instagram de"+element.name+" </a></p>"+
                  "</div><div class='video-youtube'><iframe width='560' height='315' src='https://www.youtube.com/embed/aO84h1ujzvE' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe></div>")
                .appendTo("main");
            }else if(element.genero == "punk"){
                $("<div class='div-artistas-relacionados'><img src='assets/artistas/"+element.src+"' alt='"+element.name+" image of the band' title='"+element.name+"' class='img-artistas-relacionados'>"+element.name+"<div class='name-band'> <b> "+element.name+"</b></div></div>")
              .appendTo(".no-local");
...
if(localStorage.getItem("ubication") == "Electric Wizard"){
  $('html, body').animate({ scrollTop: 0 }, 1000);
    function artistas(arrayArtista){
...
$("</br></br><h1>Artistas locales:</h1><div class='locales'></div>").appendTo(".content-extension");
        arrayArtista.forEach(element => {
            if(element.name == "Electric Wizard"){
                $("<div class='imagen-en-artista'><img src='assets/artistas/"+element.src+"' alt='"+element.name+"' ></div><h1>"+element.name+"</h1>"+
                "<div class='texto-artist'><p>&nbsp; &nbsp; &nbsp; &nbsp; Electric Wizard es una banda inglesa de doom metal de Dorset . La banda se formó en 1993 y ha grabado nueve álbumes de estudio, dos de los cuales han sido considerados hitos del género: Come My Fanatics… (1997) y Dopetrone (2000). La marca de doom metal de Electric Wizard incorpora rasgos de stoner y sludge , con letras que se centran en el ocultismo , la brujería , HP Lovecraft , películas de terror y cannabis . En 2014 formaron Witchfinder Records, un sello de Spinefarm Records , en el que planean lanzar todos los álbumes futuros."+
                "<br><br><i class='fa-brands fa-bandcamp'></i><a href='"+element.bandcamp+"' target='_blank'>Bandcamp de "+element.name+"</a><br><i class='fa-brands fa-facebook'></i><a href='"+element.facebook+"' target='_blank'>Facebook de "+element.name+"</a><br><i class='fa-brands fa-instagram-square'></i><a href='"+element.instagram+"' target='_blank'>Instagram de"+element.name+" </a></p>"+
                  "</div><div class='video-youtube'><iframe width='560' height='315' src='https://www.youtube.com/embed/XX1530GNc6U' title='YouTube video player' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe></div>")
                .appendTo("main");
            }else if(element.genero == "doom metal"){
                $("<div class='div-artistas-relacionados'><img src='assets/artistas/"+element.src+"' alt='"+element.name+" image of the band' title='"+element.name+"' class='img-artistas-relacionados'>"+element.name+"<div class='name-band'> <b> "+element.name+"</b></div></div>")
              .appendTo(".no-local");
