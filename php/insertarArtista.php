...
$sql_insert = "INSERT INTO artista (nombre_artista, id_album, imagen_artista, id_producto, instagram, bandcamp, facebook ) VALUES ('$nombre_artista', $id_album, '$imagen_artista', $id_producto, '$instagram', '$bandcamp', '$facebook')";
